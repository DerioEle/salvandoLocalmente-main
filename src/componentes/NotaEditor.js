...
export default function NotaEditor({mostraNotas}) {
  ...
  //Desafio
    const [objetoTexto, setObjetoTexto] = useState("")
    ...
    function transformar(){
      setObjetoTexto(JSON.stringify(umObjeto))
      console.log(objetoTexto)
    }

    function transformarR(){
      setTextoObjeto(JSON.parse(objetoTexto))
